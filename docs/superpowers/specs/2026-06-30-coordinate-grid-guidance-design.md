...
Keep rank/file labels inside the board, but move them only slightly inward from the original placement so the board frame no longer obscures them and they do not overlap the pieces. Do not move labels outside the board; outside labels would make the app feel more like a diagram than a physical board.
