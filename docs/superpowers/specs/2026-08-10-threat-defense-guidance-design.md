...
This state persists until the player presses **Done**, reverts the tentative move, or starts a new game. Reverting restores guidance for the committed position.
