...
Actions must be sensible direct replies to the message; include only actions that fit this turn. When warning against a staged move, do not include `playMove`. The child can always close Help separately.
